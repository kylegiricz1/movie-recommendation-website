...
- Open another terminal and go to the back-end folder. Run `pip install flask`, `pip install flask_cors`, and `brew install postgresql@15` to install all required libraries. Then run `python backend.py` to start the back-end.
